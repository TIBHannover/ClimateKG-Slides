...
- Data modelling:
  - Simple (KISS) approaches of [[GenBank]](https://ngdc.cncb.ac.cn/databasecommons/database/id/1619) (Genome Databank) and [[Protein Data Bank]](https://www.wwpdb.org/) have been used to encourage community uptake.
...
This is the main innvation of the project - being able to semi-automatically webscrape a corpus and import text and images, and make a Linked Open Data corpus backbone as an Import to Wikibase and MediaWiki.
...
::: {.column width="70%"}
<img src="images/xml.png" title="xml" alt="xml" width="80%"/>
:::
:::::
