...
::: {.column width="50%"}
### Gender Equality
<img src="images/overall-ar6-distribution.svg" title="distribution" alt="distribution" width="100%"/>
:::

::: {.column width="50%"}
### Data Dashboard
<img src="images/dashboard.png" title="Dashboard" alt="Dashboard" width="100%"/>
:::
:::::
...
### How is the KG to be used: 

1. A resource for data science - use and contribute
2. Citizen Science - Chapter annotation and enrichment 
3. Distribute to commons (Wikidata)  

### Goals:

1. Corpus KG service - CPS
2. Work with IPCC and climate community
3. Become a KG repository for all climate literature
